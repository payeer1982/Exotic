...
VERSION=
commit=false
url=https://github.com/EXOTIC/EXOTIC
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/EXOTIC/EXOTIC
...
then
    ...
    git clone https://github.com/EXOTIC/EXOTIC.SIGS.git
    git clone https://github.com/EXOTIC-DETACHED.SIGS.git
