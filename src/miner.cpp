...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != chainActive.Tip()->GetBlockHash())
            return error("EXOTICMiner : generated block is stale");
    }
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("EXOTICMiner : ProcessNewBlock, block not accepted");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        if (fProofOfStake) {
            ...
            if (!pblock->SignBlock(*pwallet)) {
                LogPrintf("EXOTICMiner(): Signing new block failed \n");
                continue;
            }
        ...
        LogPrintf("Running EXOTICMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void static ThreadBitcoinMiner(void* parg)
{
    ...
    try {
        ...
        LogPrintf("ThreadEXOTICMiner() exception");
    } catch (...) {
        LogPrintf("ThreadEXOTICMiner() exception");
    }

    LogPrintf("ThreadEXOTICMiner exiting\n");
}
